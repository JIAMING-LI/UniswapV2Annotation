...
library UniswapV2LiquidityMathLibrary {
    ...
    function computeProfitMaximizingTrade(
        ...
        // NewReserveA * NewReserveB = K = reserveA * reserveB
        // we need to achieve NewReserveA / NewReserveB = PriceA / PriceB
        // solve for ReserveA/ReserveB depend on the trading direction
        // NewReserveA * ((NewReserveA * PriceB) / PriceA) = K
        // NewReserveA = sqrt(K * (priceA/priceB))
